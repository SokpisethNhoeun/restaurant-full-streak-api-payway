...
function menuImageProxyPath(value) {
  try {
    ...
    return publicUploadPath(parsed.pathname) || bucketObjectPath(parsed.pathname);
  } catch {
    return publicUploadPath(value) || bucketObjectPath(value);
  }
}
